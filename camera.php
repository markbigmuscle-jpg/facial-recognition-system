...
<html lang="en">
  <head>
    ...
    <title>Camera</title>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/p5.js/1.11.9/p5.min.js"></script> <!-- for drawing of face keypoints-->
    <script src="https://unpkg.com/ml5@1/dist/ml5.min.js"></script> <!-- for detecting face-->
  </head>
  <body>
