		...
		<form name="camera" method="post" id="cameraForm" action="regfinish.php">
			<div class="gridbox" style="width:100%;">
				<div class="box" id="canvas" style="grid-row: 1/span 2; margin:4px;">
					<!-- create main element here so p5.js will use it here instead of creating it by itself in the body-->
					<main>
					</main>
				</div>
				<div class="box" style="grid-row: 2; margin:4px;">
					...
					<ol>
						...
						<li>When face is detected, click "Capture" at least 9 times (more is better accuracy)</li>
					</ol>
					<hr/>
					<p id="captures"></p>
					<p id="face"></p>
